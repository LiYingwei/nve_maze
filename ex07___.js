...
//////////////////////////////////////////////////////////////////////////////////
	...
	var texture = THREE.ImageUtils.loadTexture('http://localhost/img/mu1.jpg', {}, function() {
		renderer.render(scene, camera);
	});

	var texture2 = THREE.ImageUtils.loadTexture('http://localhost/img/image4.jpg', {}, function() {
		renderer.render(scene, camera);
	});
...
//////////////////////////////////////////////////////////////////////////////////
	...
	var materials = [
		...
		new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( 'http://localhost/img/px.jpg' ) } ), // right
		new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( 'http://localhost/img/nx.jpg' ) } ), // left
		new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( 'http://localhost/img/py.jpg' ) } ), // top
		new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( 'http://localhost/img/ny.jpg' ) } ), // bottom
		new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( 'http://localhost/img/pz.jpg' ) } ), // back
		new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( 'http://localhost/img/nz.jpg' ) } )  // front
